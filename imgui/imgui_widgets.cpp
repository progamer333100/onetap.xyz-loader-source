...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    ImU32 frame_color = GetColorU32((held && hovered) ? ImGuiCol_FrameBgActive : hovered ? ImGuiCol_FrameBgHovered : ImGuiCol_FrameBg);

    if (*v)
    {

        frame_color = ImGui::GetColorU32(ImVec4(189 / 255.f, 150 / 255.f, 220 / 255.f, 255.f / 255.f));
    ...
    else if (*v)
    {
        ...
        RenderCheckMark(window->DrawList, check_bb.Min + ImVec2(pad, pad), ImGui::GetColorU32(ImVec4(24 / 255.f, 23 / 255.f, 35 / 255.f, 255.f / 255.f)), square_sz - pad * 2.0f);
    }
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    if (render_cursor || render_selection)
    {
        ...
        {
            ImU32 col = GetColorU32(ImVec4(128 / 255.f, 124 / 255.f, 156 / 255.f, 255.f / 255.f));
            draw_window->DrawList->AddText(g.Font, g.FontSize, ImVec2(frame_bb.Min.x + 10, frame_bb.Min.y + 10), col, buf_display, buf_display_end, 0.0f, is_multiline ? NULL : &clip_rect);
        }
    ...
    if (thinglol)
    {
        ...
        PushStyleColor(ImGuiCol_Text, ImVec4(128 / 255.f, 124 / 255.f, 156 / 255.f, 255.f / 255.f));
        RenderText(ImVec2(frame_bb.Min.x + 10, frame_bb.Min.y + 10), label);
        PopStyleColor();

    }
        //draw_window->DrawList->AddText(g.Font, g.FontSize, ImVec2(frame_bb.Min.x + 10, frame_bb.Min.y + 10), vol_col, label, "", 0.0f, is_multiline ? NULL : &clip_rect);
        //RenderText(ImVec2(frame_bb.Max.x + style.ItemInnerSpacing.x, frame_bb.Min.y + style.FramePadding.y), label);
